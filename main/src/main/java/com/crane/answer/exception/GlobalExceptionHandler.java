...
import com.crane.answer.utils.WebUtils;
...
public class GlobalExceptionHandler {
    ...
    public R<?> notLoginException(NotLoginException e) {
        ...
        if (Objects.equals(e.getType(), NotLoginException.BE_REPLACED)) {
            ...
            stringRedisTemplate.delete("crane:login:token:" + tokenValue);
            return R.error(ErrorCode.BE_REPLACED_ERROR.getCode(), ErrorCode.BE_REPLACED_ERROR.getMessage());
        }
