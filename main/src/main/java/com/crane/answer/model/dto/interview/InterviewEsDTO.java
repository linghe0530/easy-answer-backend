...
@Data
public class InterviewEsDTO implements Serializable {
...
//    @Field(type = FieldType.Date, format = {}, pattern = DATE_TIME_PATTERN)
     ...
     * @return
     */
    public static InterviewEsDTO objToDto(Interview question) {
        if (question == null) {
            return null;
        }
        InterviewEsDTO questionEsDTO = new InterviewEsDTO();
     ...
     * @return
     */
    public static Interview dtoToObj(InterviewEsDTO questionEsDTO) {
